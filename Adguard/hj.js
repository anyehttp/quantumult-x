...
[rewrite_local]
#修改
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/anyehttp/quantumult-x/main/Adguard/hj.js
#清理
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/anyehttp/quantumult-x/main/Adguard/hj.js
...
if (typeof $response == "undefined") {
  ...
  const UAMappings = {
    ...
    '%E6%B5%8B%E5%85%89%E8%A1%A8':{ name: 'pro', id: 'com.ultrafinelabs.lightmeterultra.pro.lifetime.1600'},
    };
