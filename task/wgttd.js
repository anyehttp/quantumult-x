...
https://raw.githubusercontent.com/anyehttp/quantumult-x/main/task/wgttd-surge.sgmodule
...
多账号：
1.抓包ttdprod-mp.4008618618.com域名下的Authorization
2.打开boxjs->我的->数据查看器->在数据键输入wgttd_data,点击VIEW->在数据内容输入抓取到的Authorization，点击保存。
...
// env.js 全局
const $ = new Env("微信小程序卫岗天天订");
const ckName = "wgttd_data";
//-------------------- 一般不动变量区域 -------------------------------------
